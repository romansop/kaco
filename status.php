            ...
            function errCode2Str($code)
            {
                ...
                switch ((int)$code) {
                    ...
                    case 46:
                        ...
                        break;
                    case 47:
                        $str = "Недопустима міжфазна напруга (просідання або стрибок напруги)";
                        break;
                    case 50:
                    ...
                    case 79:
                        ...
                        break;
                    case 108:
                        $str = "Зависока напруга. Фаза 1.";
                        break;
                    case 109:
                        $str = "Зависока напруга. Фаза 2.";
                        break;
                    case 110:
                        $str = "Зависока напруга. Фаза 3.";
                        break;
                    case 111:
                        $str = "Низька напруга. Фаза 1.";
                        break;
                    case 112:
                        $str = "Низька напруга. Фаза 2.";
                        break;
                    case 113:
                        $str = "Низька напруга. Фаза 3.";
                        break;                    
                    default:
                        $str = "";
                        break;
